...
with st.sidebar:
    ...
    if st.session_state["use_api"]:
        ...
        st.session_state["api_user"] = st.text_input("Usuário", value=st.session_state.get("api_user", "WEBSERVICE"))
        st.session_state["api_pass"] = st.text_input("Senha", value=st.session_state.get("api_pass", "1"), type="password")
